...
public class MiniJmolViewer
    ...
    public MiniJmolViewer() {
        ...
        try {
            ...
            if (debug) {
                System.err.println("baseURL: MalformedURLException");
            }
            baseURL = null;
        }
    ...
    void startApplet() {
        ...
        if (debug) {
            System.err.println("setting stub");
        }
        applet.setStub(this);
        if (debug) {
        ...
        applet.start();
        if (debug) {
            System.err.println("applet started");
        }
        appletStarted = true;
    }
    ...
    void stopApplet() {
        ...
        applet.destroy();
        if (debug) {
            System.err.println("applet destroyed");
        }
        appletStarted = false;
    }
    ...
    public static void main(String argv[]) {
        ...
        if (debug) {
            System.err.println("applet installed");
        }
    ...
    public AudioClip getAudioClip(URL url) {
        if (debug) {
            System.err.println("getAudioClip: " + url);
        }
        return null;
    }
    ...
    public Image getImage(URL url) {
        if (debug) {
            System.err.println("getImage: " + url);
        }
    ...
    public Applet getApplet(String name) {
        if (debug) {
            System.err.println("getApplet: " + name);
        }
        return null;
    }
    ...
    public URL getDocumentBase() {
        if (debug) {
            System.err.println("getDocumentBase > " + baseURL);
        }
        return baseURL;
    }
    ...
    public URL getCodeBase() {
        if (debug) {
            System.err.println("getCodeBase > " + baseURL);
        }
        return baseURL;
    }
