 ...
 implements ActionListener
{
  ...
  public ExternalPanel()
  {
    ...
    {
      if (i == CaGe.lastGeneratorChoice) continue;
      ...
      if (i < 10) embedTemplateButton.setMnemonic(KeyEvent.VK_0 + (i+1) % 10);
  ...
  {
    if (defaultButton != null) defaultButton.setEnabled(nonNullCmd && ! (embedderRequired && embedTemplateGroup.getSelection() == null));
  }
  ...
  public GeneratorInfo getGeneratorInfo()
  {
    ...
    return new StaticGeneratorInfo(
     ...
     filename.toString(),
     0,
     templateInfo != null ? templateInfo.getElementRule() :
      new ValencyElementRule("H O C Si N S I"),
