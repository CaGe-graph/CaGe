...
public class FormulaHCgenPanel extends GeneratorPanel implements ActionListener {
    ...
    private EnhancedSlider CSlider = new EnhancedSlider(CaGe.debugMode);
    private JButton minCButton = new JButton();
    private JButton maxCButton = new JButton();
    private EnhancedSlider HSlider = new EnhancedSlider(CaGe.debugMode);
    private JButton minHButton = new JButton();
    private JButton maxHButton = new JButton();
    private EnhancedSlider pentSlider = new EnhancedSlider(CaGe.debugMode);
    private JButton minPentButton = new JButton();
    private JButton maxPentButton = new JButton();
    private EnhancedSlider HGapSlider = new EnhancedSlider(CaGe.debugMode);
