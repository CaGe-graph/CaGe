#define VERSION "4.2 - March 13, 2007"
#define SWITCHES "[-uagsh -c#txm#P#bpe#f#q -odGV -v]"
#define TMP
...
static int oneswitch;      /* Undocumented option -1 for debugging, implies -0 */
