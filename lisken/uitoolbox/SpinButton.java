...
*/
  ...
  private void setTextAndValue(int newValue)
  {
    ...
    if (text.hasFocus()) text.selectAll();
  }
...
//    bar.setValue(value);
  ...
  { text.setEnabled(b); up.setEnabled(b); down.setEnabled(b); }
  public Font getFont()
  { return (text == null ? super.getFont() : text.getFont()); }
  public void setFont (Font f)
  { if (text == null) super.setFont(f); else text.setFont(f); }
...
//    p.setLayout(new BoxLayout(p, BoxLayout.X_AXIS));
    ...
    e.addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent ce) { s.setEnabled(e.isSelected()); }
    });
    p.add(e);
    ...
    v.addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent ce) { s.setVisible(v.isSelected()); }
    });
    p.add(v);
    f.setContentPane(p);
    f.show();
