...
public class MinMaxEqListener implements ChangeListener, ActionListener
{
  ...
  public MinMaxEqListener
   (BoundedRangeModel minM, BoundedRangeModel maxM, boolean staticEquality)
  {
  ...
  public MinMaxEqListener
   (BoundedRangeModel minM, BoundedRangeModel maxM, ButtonModel equalityButton)
  {
